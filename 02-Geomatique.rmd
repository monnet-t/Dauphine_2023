...
require(pacman)
  pacman::p_load(c("data.table","dplyr","knitr","sf","viridis","leaflet","plotly","RColorBrewer","mapproj","units","mapsf","cartography","fitdistrplus","extRemes","evd"), install = F, update = F, character.only = T)
...
Ce cours n'abordera pas la modélisation spatio-temporelle, toutefois un exemple de données de ce type pourra être manipulé.
...
print(paste0("La superficie calculée du Groenland est de ",round(set_units(st_area(G_sf),"km^2"),0),
             " kmÂ², toutefois, les mesures officielles sont de ",G_sf$sqkm, "kmÂ²"))
...
Les données spatiales de type Raster sont assimilables à des images ou à des matrices. En d'autres termes ce sont des grilles espacées spatialement et comportant à chaque noeud ou intersection une ou plusieurs informations. Visuellement ces éléments peuvent être représentés comme des images.
